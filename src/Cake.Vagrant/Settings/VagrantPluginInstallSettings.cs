...
namespace Cake.Vagrant.Settings
{
    ...
    public class VagrantPluginInstallSettings : IVagrantCommandSettings
    {
        ...
        /// </summary>
        /// <remarks>Note that this does not only affect the single plugin being installed, by all future plugin as well. This is a limitation of the underlying plugin installer Vagrant uses.</remarks>
        public string Source { get; set; }
        /// <summary>
        /// The version of the plugin to install. By default, this command will install the latest version.
        /// </summary>
        /// <remarks>
        /// <para>You can set it to a specific version, such as "1.2.3" or you can set it to a version constraint, such as "&gt; 1.0.2". You can set it to a more complex constraint by comma-separating multiple constraints: "&gt; 1.0.2, &lt; 1.1.0"</para>
        /// </remarks>
    ...
    public static class VagrantPluginInstallSettingsExtensions
    {
        ...
        /// </summary>
        /// <param name="settings">The settings</param>
        /// <param name="version">The version or version constraint to use (as per <see cref="VagrantPluginInstallSettings.Version"/>)</param>
        /// <returns>The updated settings object</returns>
